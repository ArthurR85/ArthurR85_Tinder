...
app.post('/api/setFilter', (req, res) => {
    const { minAge, maxAge, genderPreference } = req.body;
    req.session.filter = { minAge, maxAge, genderPreference };
    res.json({ success: true, message: 'Filter gespeichert' });
});
